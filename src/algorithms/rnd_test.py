...
class RND_SAC(SAC):
    def __init__(self, cl_reg_coef=1.0, expert_buffer_size=10_000, replay_buffer_size=int(1e6), nepochs_offline=5, env_seq=None, bc_kl='reverse', distill_kl='forward', reset_offline_actor=False, **sac_kwargs):
        super().__init__(**sac_kwargs)
        self._cl_reg_coef=cl_reg_coef # According to the paper, default is 1.0 check appendix M.1 
        ...
        self._bc_kl = bc_kl # behaviour cloning KL divergence
        self._distill_kl=distill_kl # distillation KL Divergence
    ...
    def train(self, trainer):
        ...
        # We can load the model in from the path models/sac_models/
